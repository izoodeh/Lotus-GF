...
namespace TvT
{
	...
	struct TvTInfo
	{
		...
		BOOL dispelAbnormal;
		IVector bluePos;
		IVector blueRespawnPos;
		IVector redPos;
		IVector redRespawnPos;
		BOOL randomizeTeam;
		...
		wstring endEventMsg;
		list<INT32> blockedSkill;
		list<INT32> blockedItem;
		...
		BOOL friendlyFire;
		UINT inviteMessageId;
		INT32 hardwareIdLimit;
	};
